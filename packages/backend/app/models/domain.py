...
class User(Base):
    ...
    video_watch_events: Mapped[list["VideoWatchEvent"]] = relationship(
...
class BrowserSession(Base):
    ...
    __table_args__ = (Index("idx_browser_session_user_time", "user_id", "started_at"),)
...
class ScrollEvent(Base):
    ...
    __table_args__ = (Index("idx_scroll_user_time", "user_id", "timestamp"),)
...
class ThumbnailEvent(Base):
    ...
    __table_args__ = (Index("idx_thumbnail_user_time", "user_id", "timestamp"),)
...
class PageEvent(Base):
    ...
    __table_args__ = (Index("idx_page_user_time", "user_id", "timestamp"),)
...
class VideoWatchEvent(Base):
    ...
    __table_args__ = (Index("idx_video_watch_user_time", "user_id", "timestamp"),)
...
class RecommendationEvent(Base):
    ...
    __table_args__ = (Index("idx_rec_user_time", "user_id", "timestamp"),)
...
class InterventionEvent(Base):
    ...
    __table_args__ = (Index("idx_intervention_user_time", "user_id", "triggered_at"),)
...
class MoodReport(Base):
    ...
    __table_args__ = (Index("idx_mood_user_time", "user_id", "timestamp"),)
